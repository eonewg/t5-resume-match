...
当前 10 份简历全部为 `synthetic`（由 A 构造的演示数据，resume-06~10 为 2026-09-07 第二批），**没有**真实学生简历；真实简历须由组员提供授权并按本规则脱敏后补充，不得以 synthetic 冒充。
...
- 学生简历 0 份真实（10 份 synthetic，第二批 resume-06~10 于 2026-09-07 补入）；需组员授权提供真实简历并按规则脱敏。**当前所有简历相关结论都只能代表合成样本，不能当作真实学生群体的画像。**
