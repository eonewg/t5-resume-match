...
负责简历文本解析、结构化内容编辑与校验。允许修改 `backend/modules/resume/`、`tests/resume/`、`docs/integration_requests/B-*.md`。前端组件在 `frontend/src/modules/resume/`，按 [公共前端接入](../frontend-integration.md) 导出 mount 并预览。
