...
| D | Jobs、Matching、Embedding、Diagnosis，以及对应前端与模块测试 | feat/intelligence-d |
...
4. D PR 固定为 feat/intelligence-d → feat/core-a。A 验收前重新 fetch，确认 A 分支且工作区干净，记录准确源 SHA 和集成基线。
